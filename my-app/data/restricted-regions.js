//Reihenfolge identisch zu mark-markers.js bzw. list.js
export default restrictedRegions = [
  ...
  { //Ottenser Hauptstraße Klein (gehört zu Ottenser Hauptstraße; haben beide denselben Marker)
    coordinates: [
  ...
  { //Hbf (Steintordamm und Steintorwall; 2 Marker)
    coordinates: [
  ...
  { //Bellevue (gehört zu Krugkoppelbrücke; haben beide denselben Marker)
    coordinates: [
