                        ...
                        <View style={styles.middleContainerList}>
                                <ScrollView style={styles.scrollView}>
                                        ...
                                        <View style={styles.listPointBox}>
                                                ...
                                                {/*Hier ist quasi Text in Text, damit die Hauptwörter eine andere Farbe haben können */}
                                        ...
                                        <View style={styles.listPointBoxHinweis}>
                                                <Ionicons name="alert-circle-outline" size={size} style={styles.listIcons} />
                                        ...
                                        <View style={styles.listPointBox}>
                                                ...
                                                <Text style={styles.listText}><Text style={styles.listHinweis}>Quelle:</Text> Die Daten für maskenpflichtige Orte, Straßen und Ausnahmen wurden aus der offiziellen <Text style={{ color: { color } }}
